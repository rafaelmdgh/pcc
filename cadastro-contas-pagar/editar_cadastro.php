...
if($_POST){
    ...
    $sql = "UPDATE contas_pagar SET pagar_codigo_fornecedor = :fornecedor, pagar_valor = :valor, pagar_dt_vencimento = :dt_vencimento, pagar_observacao = :observacao WHERE pagar_nr_lancamento = :nr_lancamento AND pagar_usuario = :usuario";
